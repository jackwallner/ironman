...
/// On-device record of how someone met Iron Splits Pro before they bought it: which
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.ironman", category: "Conversion")
    ...
    private static let impressionPrefix = "ironsplits_paywall_"
