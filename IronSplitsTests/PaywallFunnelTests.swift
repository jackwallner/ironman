...
final class PaywallFunnelTests: XCTestCase {
    ...
    func testCountsPitchesPerSurfaceAndInTotal() {
        ConversionDiagnostics.recordPitchView(impressionID: "ironsplits_paywall_upgrade")
        ConversionDiagnostics.recordPitchView(impressionID: "ironsplits_paywall_upgrade")
        ConversionDiagnostics.recordPitchView(impressionID: "ironsplits_paywall_race_book_export")
        ...
        XCTAssertEqual(attributes["pitch_last"], "race_book_export")
    }
    ...
    func testConversionFreezesTheSurfaceAndCountAtTheMomentOfSale() {
        ...
        let attributes = ConversionDiagnostics.subscriberAttributes
        XCTAssertEqual(attributes["converted_surface"], "race_book_export")
    ...
    func testAttributeKeysStayInsideRevenueCatsLimit() {
        ...
        ConversionDiagnostics.recordPitchView(impressionID: "ironsplits_paywall_\(long)")
